...
python3 run_src/eval_sc.py \
    ...
    --eval_split dev \
    --eval_sample_size -1 \
    --eval_save_path save/siqa_70b_sc1_10s.json \
    --eval_task SIQA \
    --num_votes 1 \
    --num_shot 10 \
    --max_new_tokens 16 \
#        --eval_save_path /mnt/interns/hieutran/research/llm_s         afe/long-form-factuality/results/usmle_test_zs_evaluation.json \
#    --memory_0=80 \
#    --memory_1=80 \
#    --memory_2=70 \
#    --memory_3=40 \