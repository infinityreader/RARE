...
sys_message = "\nYou are a helpful assistant. For each of the following multiple-choice questions, please give a chain of thought reasoning and select the correct answer. In the end of assistant's response, a final answer is given in the format of \"The answer is: <ANSWER>.\""
usmle_template = '''
Question: 
{question}
Choices:
