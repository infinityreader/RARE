...
commonsense_in_context_examples =[
'''
...
(C) save money
**Answer**:
The answer is [B] Open up her laptop.
''',
'''
...
**Answer**:
The answer is [C] tell someone about the party.
''',
]

piqa_in_context_examples =[
'''
...
**Answer**:
The answer is: [A] Weld the metal together to get it to stay firmly in place.
''',
'''
...
**Answer**:
The answer is: [B] take a sponge and soak it in water. Put the sponge in a refrigerator and let it freeze. Once frozen, take it out and put it in a Ziploc bag. You can now use it as an ice pack.
''',
'''
**Question**: how do you open a capri-sun, 
**Choices**:
(A) open the straw attached to the juice, and then stick it in the small hole at the front of the pouch
(B) cut the top off with scissors
**Answer**:
The answer is: [A] open the straw attached to the juice, and then stick it in the small hole at the front of the pouch
''',
]
    ...
    def eval_one_split(self, data):
        ...
        for i in pbar:
            ...
            for jdx in range(len(batch_data)):
                ...
                chat_prompt = chat_prompt + "**Answer**: \nThe answer is "
